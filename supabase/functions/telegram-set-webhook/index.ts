...
Deno.serve(async (req) => {
  ...
  const commands = [
    ...
    { command: "status", description: "Status bukti transfer & premium kamu" },
    { command: "online", description: "Lihat jumlah user online" },
    { command: "setdefault", description: "[Premium] Atur default gender/provinsi pencarian" },
